          ...
          .tab-pane(:class="{'active': tab == 0}")
            .form-group.row
              ...
              .col-sm-8
                ...
                button.btn.btn-warning.mr-1(@click="send({command: 'REF', kkm: kkm, amount: amount, no: check})") Refund 
                //- InvoiceNumber и RRN
    ...
    .col-sm-7
      ...
      .row
        ...
        .col-sm-10.text-right
          small.text-muted Number of records {{logSize}}
